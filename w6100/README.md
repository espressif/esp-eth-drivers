...
> **Note:** This component requires ESP-IDF v5.3 or newer. Multicast filter callbacks (`add_mac_filter` / `rm_mac_filter` / `set_all_multicast`) are available on IDF v5.5+.
...
w6100_config.base.int_gpio_num = CONFIG_EXAMPLE_ETH_SPI_INT_GPIO;

#if CONFIG_EXAMPLE_ETH_SPI_INT_GPIO < 0
w6100_config.base.poll_period_ms = CONFIG_EXAMPLE_ETH_SPI_POLLING_MS_VAL;
#endif
```
