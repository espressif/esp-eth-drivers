...
parser = argparse.ArgumentParser(description='Establish TCP connection to a server using Berkeley sockets and periodically send transmission expecting echo', epilog='Part of the tcp_server example for esp_eth_drivers')
