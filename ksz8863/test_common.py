...
class VirtualMachineSSH(RemoteMachineSSH):
    ...
    def get_all_interfaces_ips(self):
        ...
        interfaces.remove("lo") # Remove loopback interface becuse it doesn't matter
...
class HelperFunctionsClass:
    # Methods
    def PerformTransmissions(self, endnode, runner):
        ...
        endnode.execute(f"python3 -u vm_test_app.py tx 120.140.1.1")
