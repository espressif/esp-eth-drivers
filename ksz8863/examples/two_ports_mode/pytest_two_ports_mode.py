...
"""
Test for two ports example
Includes following tests:
 i. Two ports link test
ii. Two ports transmit test
"""
import os
...
def test_ksz8863_two_ports_link(dut: Dut) -> None:
    """
    Check that the host device reacts to link being set up and down on both ports
    """
...
def test_ksz8863_two_ports_test_messages() -> None:
    """
    Check that both ports are sending test messages periodically
    """
